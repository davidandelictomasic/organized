using Organized.Application.Common.Validation;

namespace Organized.Application.Common.Model
{
    public class Result<TVaule> where TVaule : class
    {
        ...
        public bool HasError => Errors.Any(validationResult => validationResult.ValidationSeverity == "Error");
        public bool HasInfo => Infos.Any(validationResult => validationResult.ValidationSeverity == "Info");
        public bool HasWarning => Warnings.Any(validationResult => validationResult.ValidationSeverity == "Warning");
        ...
        {
            _errors?.AddRange(validationResult.ValidationItems.Where(x => x.ValidationSeverity == "Error").Select(x => ValidationResultItem.FromValidationItem(x)));
